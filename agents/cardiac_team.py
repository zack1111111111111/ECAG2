...
Extracted features:
  ...
  R-peak count in window  : {n_peaks if n_peaks is not None else 'N/A'}  (over {window_s} s)
...
Note: HR is computed from RR intervals, not from raw R-peak count.
Trust the HR field directly. Please analyze and hand off."""
